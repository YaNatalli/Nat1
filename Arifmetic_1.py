...
print(result_s_root)
# 15. Создать переменную result_m_s_root в которой вы найдёте квадратный корень любой
# из переменной item используя библиотеку math.
...
# 19. Присвоить переменной item_1 odd (нечетные) значение
item_1=15
...
# 23. Создать переменную result_m_floor и result_division округлить до
# ближайшего целого меньшего чем result_division.
...
# /_item_relult_division=b_item_t / b_item_f
...
print(type(b_item_1_int),b_item_1_int)
...
print(type(b_item_2_int),b_item_2_int)
